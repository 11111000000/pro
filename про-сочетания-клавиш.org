...
;;; про-сочетания-клавиш.el --- Key bindings configuration -*- lexical-binding: t; -*-
;;; Commentary:
;; This package sets up custom key bindings for both standard Emacs usage and EXWM.
;;; Code:
...
;;; про-сочетания-клавиш.el ends here
#+END_SRC
