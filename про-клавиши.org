* TODO Клавиши текстового режима
...
| C-x C-t       | pro/telega-select-chat-or-contact           |
...
| C-c i t       | pro-ai-gptel-aibo-apply-actions-from-region |
| s-a           | aidermacs-transient-menu                    |
| C-z           | nil                                         |
| C-c M-n       | pro/пересобрать-nix                         |
| C-c M-k       | pro/reload-keys                             |
| C-c M-t       | multi-vterm                                 |
...
| s-F                     | ace-swap-window                      |
| C-c 1                   | profiler-start                       |
| C-c 2                   | profiler-stop                        |
| C-c 3                   | profiler-report                      |
...
| s-s                     | nil                                  |
| s-s c                   | скринкаст                            |
| s-s o                   | скринкаст-стоп                       |
| s-M-'                   | exwm-edit--compose-minibuffer        |
| <print>                 | скриншот-области                     |
| s-<print>               | скриншот                             |
| s-s s                   | скриншот-области                     |
| s-"                     | exwm-edit--compose                   |
| s-b                     | ibuffer                              |
| s-m                     | popwin:messages                      |
| C-c M-n                 | pro/пересобрать-nix                  |
