...
| C-c ik         | gptel-abort                         |
| C-c ig         | gptel-abort                         |
| C-c ic         | gptel-navigator-toggle              |
| C-c in         | gptel-navigator-toggle              |
...
| s-i s          | gptel-navigator-context-save        |
| s-i l          | gptel-navigator-context-load        |
| s-i k          | gptel-abort                         |
| s-i g          | gptel-abort                         |
| s-i q          | elysium-query                       |
| s-i w          | whisper-run                         |
