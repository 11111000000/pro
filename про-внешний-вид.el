...
;; В 1968 году американский изобретатель Дуглас Карл Энгельбарт, совместно с командой из Стэнфордского исследовательского института,
;; создают первые элементы человеко-машинного интерфейса (UI — англ. user interface). Эти элементы являлись частью революционной
;; разработки NLS (NLS — англ. oN-Line System) системы которая реализовывала одновременную работу нескольких терминалов, над одними
;; и теми же документами. В этом же году 9 декабря, состоялась демонстрация онлайн системы, которая получила название «The Mother of
;; All Demos» дословно «мать всех демонстраций», на которой можно было увидеть работу с гипертекстом и курсор.
