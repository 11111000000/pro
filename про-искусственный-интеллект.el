...
(defun куплет-за-сутки ()
  ...
  (interactive)
  (новости-за-время 24
                    "Отсортируй похожие сюжеты новостей и сделай лёгкий красивый поэтический рифмованый пересказ:"))
...
(defun смешное-за-сутки ()
  ...
  (interactive)
  (новости-за-время 24
                    "Перескажи только смешные и забавные, простым текстом, без Markdown, только суммаризацию, но в стиле робота из Автостопом по галактике, добавь максимально ироничный и грустный комментарий робота:"))
...
(defun война-за-час ()
  ...
  (interactive)
  (новости-за-время 1
                    "Перескажи кратко только военные новости, разбей на группы по смыслу, систематизируй и суммаризируй, отфильтруй спам и рекламу, простым текстом, без Markdown:"))
