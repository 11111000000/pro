;;; про-файлы-и-папки.el --- Управление файлами и папками в Emacs -*- lexical-binding: t; -*-
;;
;; Автор: Пётр <11111000000@email.com>
;; Версия: 1.0
;; Keywords: dired, files, directories, navigation
;; URL: https://github.com/username/emacs.d/blob/main/навигация/про-файлы-и-папки.el
;;
;;; Commentary:
;;
;; Этот файл настраивает работу с файлами и папками в Emacs, следуя принципам
...
;;
;; Почему это важно? Dired — встроенный файловый менеджер Emacs. Здесь мы
;; добавляем удобные клавиши для навигации, скрытие деталей, автоматическое
;; обновление буферов. Это делает работу с файлами такой же удобной как в
;; современных файловых менеджерах.
;;
;; Структура файла:
;;  0. Введение и зависимости
;;  1. Настройка Dired
;;  2. Клавиши навигации
;;  3. Скрытие и фильтрация
;;  4. Утилиты для работы с файлами
;;  5. Финал: Provide и ends here
;;
;; Использование: Загружается через (require 'про-файлы-и-папки) в init.el.
