;;; про-фикс-corfu.el --- Исправления для Corfu в мультимониторной конфигурации -*- lexical-binding: t; -*-
;;
;; Автор: Пётр <11111000000@email.com>
;; Версия: 1.0
;; Keywords: corfu, posframe, multi-monitor, exwm
;; URL: https://github.com/username/emacs.d/blob/main/разработка/про-фикс-corfu.el
;;
;;; Commentary:
;;
;; Этот файл содержит исправления для корректной работы пакетов,
;; использующих posframe, в мультимониторной конфигурации, следуя принципам
;; литературного программирования.
;;
;; Почему это важно? При использовании нескольких мониторов posframe
;; может отображаться на неправильном мониторе. Этот модуль добавляет
;; функцию для определения геометрии активного монитора и advise-функции
;; для корректного позиционирования.
;;
;; Структура файла:
;;  0. Введение и зависимости
;;  1. Функция определения геометрии монитора
;;  2. Advise для пакетов с posframe
;;  3. Финал: Provide и ends here
;;
;; Использование: Загружается через (require 'про-фикс-corfu) в init.el
;; после про-автодополнение.
;;
;;; Code:
