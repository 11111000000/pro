...
(leaf god-mode
  ...
  :ensure t  
  :diminish " ☯"
  :hook ((god-mode-disabled-hook . обновить-курсор)
         (god-mode-enabled-hook . обновить-курсор)
         ;;(god-mode-enabled . restore-input-method)
         (god-mode-enabled-hook . toggle-off-input-method))
  ...
  :custom ((god-exempt-major-modes . '(dired-mode wdired-mode image-mode help-mode grep-mode exwm-mode
