...
### Name: TTY.CleanUI
Stability: [FLUID]
Spec: В TTY интерфейс остаётся plain-text: без `prettify-symbols`, без `org-modern`, без Unicode ellipsis и без декоративных glyph в Eshell prompt/banner.
API: `про-tty-clean-ui-setup`, `про-текстовый-режим`, `приглашение-eshell`, `pro/eshell-system-banner-string`
Proof: `emacs --batch -l тесты/unit/tty-clean-ui.el`
